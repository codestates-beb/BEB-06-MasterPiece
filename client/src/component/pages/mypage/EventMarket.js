...
const EventMarket = () => {
  ...
  const privateKey =
    "79c41469be6506e9a39556ac6da875ff51bc13c5d02f3d01184ed3c35e66bc27";
  ...
  const handleBuy = async (e) => {
    ...
    const transaction = nftContract.methods.transfer(
      eventMarket,
      account,
      eventNft[id].token_id
    );
    const options = {
      from: account,
      to: nftAddress,
    ...
    const receipt = await web3.eth
      ...
      .then((res) => {
        console.log(res);
        contract.methods
          .erc20transfer(account, eventMarket, 30)
          .send(transaction2)
          .then((res) => {
            console.log(res);
          });
